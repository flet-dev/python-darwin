...
for arch in "${archs[@]}"; do
    rsync -av --exclude-from=$script_dir/python-darwin-dart.exclude $python_apple_support_root/install/iOS/$arch/python-*/lib/python$python_version_short/* $stdlib_dir/$arch
done
